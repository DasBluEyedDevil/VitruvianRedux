...
.method private static final companionOrNull(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    .locals 3
    .param p0, "$this$companionOrNull"    # Ljava/lang/Class;
    ...
    .line 133
    .local v1, "companion":Ljava/lang/reflect/Field;
    const/4 v2, 0x1
    ...
    .end local v1    # "companion":Ljava/lang/reflect/Field;
    goto :goto_0
...
.method public static final compiledSerializerImpl(Lkotlin/reflect/KClass;)Lkotlinx/serialization/KSerializer;
    .locals 1
    .param p0, "$this$compiledSerializerImpl"    # Lkotlin/reflect/KClass;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
...
.method public static final varargs constructSerializerForGivenTypeArgs(Ljava/lang/Class;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;
    .locals 4
    .param p0, "$this$constructSerializerForGivenTypeArgs"    # Ljava/lang/Class;
    .param p1, "args"    # [Lkotlinx/serialization/KSerializer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 215
    .local v1, "it":Lkotlinx/serialization/KSerializer;
    const/4 v2, 0x0

    .line 51
    .local v2, "$i$a$-let-PlatformKt$constructSerializerForGivenTypeArgs$1":I
    return-object v1

    .line 54
    .end local v1    # "it":Lkotlinx/serialization/KSerializer;
    .end local v2    # "$i$a$-let-PlatformKt$constructSerializerForGivenTypeArgs$1":I
    :cond_2
    array-length v1, p1
    ...
    invoke-static {p0, v1}, Lkotlinx/serialization/internal/PlatformKt;->findInNamedCompanion(Ljava/lang/Class;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;

    move-result-object v1

    .line 55
    .local v1, "fromNamedCompanion":Lkotlinx/serialization/KSerializer;
    if-eqz v1, :cond_3
    ...
    invoke-direct {v2, v3}, Lkotlinx/serialization/PolymorphicSerializer;-><init>(Lkotlin/reflect/KClass;)V
...
.method public static final varargs constructSerializerForGivenTypeArgs(Lkotlin/reflect/KClass;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;
    .locals 2
    .param p0, "$this$constructSerializerForGivenTypeArgs"    # Lkotlin/reflect/KClass;
    .param p1, "args"    # [Lkotlinx/serialization/KSerializer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v0, v1}, Lkotlinx/serialization/internal/PlatformKt;->constructSerializerForGivenTypeArgs(Ljava/lang/Class;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;
...
.method private static final createEnumSerializer(Ljava/lang/Class;)Lkotlinx/serialization/KSerializer;
    .locals 4
    .param p0, "$this$createEnumSerializer"    # Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 142
    .local v0, "constants":[Ljava/lang/Object;
    ...
    invoke-direct {v1, v2, v3}, Lkotlinx/serialization/internal/EnumSerializer;-><init>(Ljava/lang/String;[Ljava/lang/Enum;)V
...
.method private static final varargs findInNamedCompanion(Ljava/lang/Class;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;
    .locals 13
    .param p0, "$this$findInNamedCompanion"    # Ljava/lang/Class;
    .param p1, "args"    # [Lkotlinx/serialization/KSerializer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 67
    .local v0, "namedCompanion":Ljava/lang/Object;
    if-eqz v0, :cond_0
    ...
    invoke-static {v0, v1}, Lkotlinx/serialization/internal/PlatformKt;->invokeSerializerOnCompanion(Ljava/lang/Object;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;
    ...
    .line 68
    .local v2, "$i$a$-let-PlatformKt$findInNamedCompanion$1":I
    return-object v1

    .line 72
    .end local v1    # "it":Lkotlinx/serialization/KSerializer;
    .end local v2    # "$i$a$-let-PlatformKt$findInNamedCompanion$1":I
    :cond_0
    nop
    ...
    .local v2, "$this$singleOrNull$iv":[Ljava/lang/Object;
    const/4 v3, 0x0

    .line 216
    .local v3, "$i$f$singleOrNull":I
    const/4 v4, 0x0
    ...
    .line 73
    .local v10, "$i$a$-singleOrNull-PlatformKt$findInNamedCompanion$2":I
    ...
    .end local v10    # "$i$a$-singleOrNull-PlatformKt$findInNamedCompanion$2":I
    if-eqz v11, :cond_2
    ...
    .line 73
    .end local v2    # "$this$singleOrNull$iv":[Ljava/lang/Object;
    .end local v3    # "$i$f$singleOrNull":I
    ...
    .line 73
    :goto_2
    instance-of v3, v2, Lkotlinx/serialization/KSerializer;
...
.method private static final findNamedCompanionByAnnotation(Ljava/lang/Class;)Ljava/lang/Object;
    .locals 10
    .param p0, "$this$findNamedCompanionByAnnotation"    # Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 82
    .local v8, "$i$a$-firstOrNull-PlatformKt$findNamedCompanionByAnnotation$companionClass$1":I
    ...
    .end local v8    # "$i$a$-firstOrNull-PlatformKt$findNamedCompanionByAnnotation$companionClass$1":I
    :goto_1
    if-eqz v9, :cond_1
    ...
    .line 85
    .local v6, "companionClass":Ljava/lang/Class;
    :cond_3
...
.method private static final findObjectSerializer(Ljava/lang/Class;)Lkotlinx/serialization/KSerializer;
    .locals 16
    .param p0, "$this$findObjectSerializer"    # Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 148
    .local v4, "$i$a$-let-PlatformKt$findObjectSerializer$1":I
    const-string v5, "java."

    const/4 v6, 0x2

    invoke-static {v0, v5, v3, v6, v2}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    .end local v4    # "$i$a$-let-PlatformKt$findObjectSerializer$1":I
    :goto_1
    if-nez v0, :cond_2
    ...
    .local v0, "$this$singleOrNull$iv":[Ljava/lang/Object;
    const/4 v4, 0x0

    .line 229
    .local v4, "$i$f$singleOrNull":I
    const/4 v5, 0x0
    ...
    .local v10, "it":Ljava/lang/reflect/Field;
    const/4 v11, 0x0

    .line 151
    .local v11, "$i$a$-singleOrNull-PlatformKt$findObjectSerializer$field$1":I
    ...
    .line 232
    .end local v10    # "it":Ljava/lang/reflect/Field;
    .end local v11    # "$i$a$-singleOrNull-PlatformKt$findObjectSerializer$field$1":I
    :goto_4
    if-eqz v10, :cond_7
    ...
    .line 151
    .end local v0    # "$this$singleOrNull$iv":[Ljava/lang/Object;
    .end local v4    # "$i$f$singleOrNull":I
    ...
    .local v4, "$this$singleOrNull$iv":[Ljava/lang/Object;
    const/4 v6, 0x0

    .line 240
    .local v6, "$i$f$singleOrNull":I
    const/4 v7, 0x0

    .line 241
    .local v7, "single$iv":Ljava/lang/Object;
    const/4 v8, 0x0
    ...
    .line 156
    .local v14, "$i$a$-singleOrNull-PlatformKt$findObjectSerializer$method$1":I
    ...
    .end local v14    # "$i$a$-singleOrNull-PlatformKt$findObjectSerializer$method$1":I
    :goto_8
    if-eqz v1, :cond_e
    ...
    .line 246
    .end local v7    # "single$iv":Ljava/lang/Object;
    .local v1, "single$iv":Ljava/lang/Object;
    const/4 v7, 0x1
    ...
    .line 242
    .end local v1    # "single$iv":Ljava/lang/Object;
    .end local v11    # "element$iv":Ljava/lang/Object;
    .restart local v7    # "single$iv":Ljava/lang/Object;
    :cond_e
    ...
    .line 156
    .end local v4    # "$this$singleOrNull$iv":[Ljava/lang/Object;
    .end local v6    # "$i$f$singleOrNull":I
    .end local v7    # "single$iv":Ljava/lang/Object;
    .end local v8    # "found$iv":Z
    :goto_9
...
.method public static final getChecked([Ljava/lang/Object;I)Ljava/lang/Object;
    .locals 2
    .param p0, "$this$getChecked"    # [Ljava/lang/Object;
    .param p1, "index"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final initBuiltins()Ljava/util/Map;
    ...
    .local v1, "$this$initBuiltins_u24lambda_u2414":Ljava/util/Map;
    const/4 v2, 0x0

    .line 168
    .local v2, "$i$a$-buildMap-PlatformKt$initBuiltins$1":I
    ...
    sget-object v4, Lkotlin/jvm/internal/CharCompanionObject;->INSTANCE:Lkotlin/jvm/internal/CharCompanionObject;

    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/jvm/internal/CharCompanionObject;)Lkotlinx/serialization/KSerializer;
    ...
    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/ULong$Companion;)Lkotlinx/serialization/KSerializer;
    ...
    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/UInt$Companion;)Lkotlinx/serialization/KSerializer;
    ...
    sget-object v4, Lkotlin/jvm/internal/ShortCompanionObject;->INSTANCE:Lkotlin/jvm/internal/ShortCompanionObject;

    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/jvm/internal/ShortCompanionObject;)Lkotlinx/serialization/KSerializer;
    ...
    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/UShort$Companion;)Lkotlinx/serialization/KSerializer;
    ...
    sget-object v4, Lkotlin/jvm/internal/ByteCompanionObject;->INSTANCE:Lkotlin/jvm/internal/ByteCompanionObject;

    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/jvm/internal/ByteCompanionObject;)Lkotlinx/serialization/KSerializer;
    ...
    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/UByte$Companion;)Lkotlinx/serialization/KSerializer;
    ...
    invoke-static {v4}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/Unit;)Lkotlinx/serialization/KSerializer;
    ...
    .line 193
    .local v4, "$i$a$-loadSafe-PlatformKt$initBuiltins$1$1":I
    :try_start_0
    const-class v5, Lkotlin/time/Duration;
    ...
    invoke-static {v6}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/time/Duration$Companion;)Lkotlinx/serialization/KSerializer;
    ...
    .end local v4    # "$i$a$-loadSafe-PlatformKt$initBuiltins$1$1":I
    goto :goto_0
    ...
    .line 196
    .end local v3    # "$i$f$loadSafe":I
    move-object v3, v1

    .local v3, "$this$initBuiltins_u24lambda_u2414_u24lambda_u2412":Ljava/util/Map;
    const/4 v4, 0x0

    .line 197
    .local v4, "$i$a$-run-PlatformKt$initBuiltins$1$2":I
    const/4 v5, 0x0

    .line 257
    .local v5, "$i$f$loadSafe":I
    nop
    ...
    .line 197
    .local v6, "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$1":I
    :try_start_1
    const-class v7, Lkotlin/ULongArray;
    ...
    .end local v6    # "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$1":I
    goto :goto_1
    ...
    .line 198
    .end local v5    # "$i$f$loadSafe":I
    const/4 v5, 0x0

    .line 263
    .restart local v5    # "$i$f$loadSafe":I
    nop
    ...
    .line 198
    .local v6, "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$2":I
    :try_start_2
    const-class v7, Lkotlin/UIntArray;
    ...
    .end local v6    # "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$2":I
    goto :goto_2
    ...
    .line 199
    .local v6, "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$3":I
    :try_start_3
    const-class v7, Lkotlin/UShortArray;
    ...
    .end local v6    # "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$3":I
    goto :goto_3
    ...
    .line 200
    .local v6, "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$4":I
    :try_start_4
    const-class v7, Lkotlin/UByteArray;
    ...
    .end local v6    # "$i$a$-loadSafe-PlatformKt$initBuiltins$1$2$4":I
    goto :goto_4
    ...
    .line 196
    .end local v3    # "$this$initBuiltins_u24lambda_u2414_u24lambda_u2412":Ljava/util/Map;
    .end local v4    # "$i$a$-run-PlatformKt$initBuiltins$1$2":I
    nop
    ...
    .line 203
    .local v4, "$i$a$-loadSafe-PlatformKt$initBuiltins$1$3":I
    :try_start_5
    const-class v5, Lkotlin/uuid/Uuid;

    invoke-static {v5}, Lkotlin/jvm/internal/Reflection;->getOrCreateKotlinClass(Ljava/lang/Class;)Lkotlin/reflect/KClass;

    move-result-object v5

    sget-object v6, Lkotlin/uuid/Uuid;->Companion:Lkotlin/uuid/Uuid$Companion;

    invoke-static {v6}, Lkotlinx/serialization/builtins/BuiltinSerializersKt;->serializer(Lkotlin/uuid/Uuid$Companion;)Lkotlinx/serialization/KSerializer;
    ...
    .end local v4    # "$i$a$-loadSafe-PlatformKt$initBuiltins$1$3":I
    goto :goto_5
    ...
    .line 166
    .end local v1    # "$this$initBuiltins_u24lambda_u2414":Ljava/util/Map;
    .end local v2    # "$i$a$-buildMap-PlatformKt$initBuiltins$1":I
...
.method private static final varargs invokeSerializerOnCompanion(Ljava/lang/Object;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;
    .locals 5
    .param p0, "companion"    # Ljava/lang/Object;
    .param p1, "args"    # [Lkotlinx/serialization/KSerializer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final varargs invokeSerializerOnDefaultCompanion(Ljava/lang/Class;[Lkotlinx/serialization/KSerializer;)Lkotlinx/serialization/KSerializer;
    ...
    .line 113
    .local v0, "companion":Ljava/lang/Object;
    :cond_0
    array-length v1, p1
...
.method public static final isInterface(Lkotlin/reflect/KClass;)Z
    .locals 1
    .param p0, "$this$isInterface"    # Lkotlin/reflect/KClass;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
...
.method private static final isNotAnnotated(Ljava/lang/Class;)Z
    .locals 1
    .param p0, "$this$isNotAnnotated"    # Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
...
.method private static final isPolymorphicSerializer(Ljava/lang/Class;)Z
    .locals 4
    .param p0, "$this$isPolymorphicSerializer"    # Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 105
    .local v0, "serializable":Lkotlinx/serialization/Serializable;
    if-eqz v0, :cond_1
...
.method public static final isReferenceArray(Lkotlin/reflect/KClass;)Z
    .locals 1
    .param p0, "rootClass"    # Lkotlin/reflect/KClass;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlin/reflect/KClass<",
...
.method public static final platformSpecificSerializerNotRegistered(Lkotlin/reflect/KClass;)Ljava/lang/Void;
    .locals 1
    .param p0, "$this$platformSpecificSerializerNotRegistered"    # Lkotlin/reflect/KClass;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlin/reflect/KClass<",
...
.method public static final serializerNotRegistered(Ljava/lang/Class;)Ljava/lang/Void;
    .locals 2
    .param p0, "$this$serializerNotRegistered"    # Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/Class<",
    ...
    invoke-static {v1}, Lkotlinx/serialization/internal/Platform_commonKt;->notRegisteredMessage(Lkotlin/reflect/KClass;)Ljava/lang/String;
...
.method public static final toNativeArrayImpl(Ljava/util/ArrayList;Lkotlin/reflect/KClass;)[Ljava/lang/Object;
    .locals 2
    .param p0, "$this$toNativeArrayImpl"    # Ljava/util/ArrayList;
    .param p1, "eClass"    # Lkotlin/reflect/KClass;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
