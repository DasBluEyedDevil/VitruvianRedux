...
.method private final runWriter()V
    ...
    iget-object v5, p0, Lokhttp3/internal/ws/RealWebSocket;->writerTask:Lokhttp3/internal/concurrent/Task;

    .line 460
    .local v5, "writerTask":Lokhttp3/internal/concurrent/Task;
    if-eqz v5, :cond_2
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    .line 279
    new-instance v2, Lokhttp3/internal/ws/WebSocketReader;
    ...
    invoke-virtual {v1, v0}, Lokhttp3/internal/ws/WebSocketExtensions;->noContextTakeover(Z)Z
    ...
    iput-object v2, p0, Lokhttp3/internal/ws/RealWebSocket;->reader:Lokhttp3/internal/ws/WebSocketReader;
...
.method public final writeOneFrame$okhttp()Z
    ...
    .local v18, "pong":Ljava/lang/Object;
    :try_start_5
    new-instance v3, Lokhttp3/internal/ws/RealWebSocket$writeOneFrame$lambda$8$$inlined$execute$default$1;

    invoke-direct {v3, v13, v0, v1}, Lokhttp3/internal/ws/RealWebSocket$writeOneFrame$lambda$8$$inlined$execute$default$1;-><init>(Ljava/lang/String;ZLokhttp3/internal/ws/RealWebSocket;)V
    ...
    .line 670
    invoke-virtual {v12, v3, v14, v15}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
    :try_end_5
    ...
    .end local v18    # "pong":Ljava/lang/Object;
    .local v0, "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    ...
    .restart local v18    # "pong":Ljava/lang/Object;
    if-nez v4, :cond_4
    ...
    .line 527
    .local v3, "message":Lokhttp3/internal/ws/RealWebSocket$Message;
    invoke-static {v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-virtual {v3}, Lokhttp3/internal/ws/RealWebSocket$Message;->getFormatOpcode()I
    ...
    .line 531
    .end local v3    # "message":Lokhttp3/internal/ws/RealWebSocket$Message;
    ...
    invoke-virtual {v2, v3, v10}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokio/ByteString;)V

    .line 536
    if-eqz v7, :cond_7

    .line 537
    iget-object v3, v1, Lokhttp3/internal/ws/RealWebSocket;->listener:Lokhttp3/WebSocketListener;
    ...
    invoke-virtual {v3, v10, v5, v6}, Lokhttp3/WebSocketListener;->onClosed(Lokhttp3/WebSocket;ILjava/lang/String;)V
    :try_end_9
