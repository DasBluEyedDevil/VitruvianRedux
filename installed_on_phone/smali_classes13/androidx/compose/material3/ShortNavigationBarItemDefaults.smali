...
.method public final colors(Landroidx/compose/runtime/Composer;I)Landroidx/compose/material3/NavigationItemColors;
    ...
    const-string v1, "C(colors)287@12395L11:ShortNavigationBar.kt#uh7d8r"
    ...
    const-string v2, "androidx.compose.material3.ShortNavigationBarItemDefaults.colors (ShortNavigationBar.kt:287)"
    ...
    invoke-virtual {p0, v0}, Landroidx/compose/material3/ShortNavigationBarItemDefaults;->getDefaultShortNavigationBarItemColors$material3(Landroidx/compose/material3/ColorScheme;)Landroidx/compose/material3/NavigationItemColors;
...
.method public final colors-69fazGs(JJJJJJJLandroidx/compose/runtime/Composer;II)Landroidx/compose/material3/NavigationItemColors;
    ...
    invoke-virtual {v2}, Landroidx/compose/material3/tokens/NavigationBarTokens;->getItemActiveIconColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v2}, Landroidx/compose/material3/tokens/NavigationBarTokens;->getItemActiveLabelTextColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v2}, Landroidx/compose/material3/tokens/NavigationBarTokens;->getItemActiveIndicatorColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v2}, Landroidx/compose/material3/tokens/NavigationBarTokens;->getItemInactiveIconColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    invoke-virtual {v2}, Landroidx/compose/material3/tokens/NavigationBarTokens;->getItemInactiveLabelTextColor()Landroidx/compose/material3/tokens/ColorSchemeKeyTokens;
    ...
    const-string v4, "androidx.compose.material3.ShortNavigationBarItemDefaults.colors (ShortNavigationBar.kt:312)"
...
.method public final getDefaultShortNavigationBarItemColors$material3(Landroidx/compose/material3/ColorScheme;)Landroidx/compose/material3/NavigationItemColors;
    .locals 23
    .param p1, "$this$defaultShortNavigationBarItemColors"    # Landroidx/compose/material3/ColorScheme;
    ...
    .line 341
    .local v3, "$i$a$-also-ShortNavigationBarItemDefaults$defaultShortNavigationBarItemColors$1":I
    invoke-virtual {v0, v1}, Landroidx/compose/material3/ColorScheme;->setDefaultShortNavigationBarItemColorsCached$material3(Landroidx/compose/material3/NavigationItemColors;)V

    .line 325
    .end local v1    # "it":Landroidx/compose/material3/NavigationItemColors;
    .end local v3    # "$i$a$-also-ShortNavigationBarItemDefaults$defaultShortNavigationBarItemColors$1":I
    :cond_0
    return-object v1
.end method
