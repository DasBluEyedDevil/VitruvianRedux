...
public final class CartesianChart$transformationPreparationConsumer$1 implements CartesianChart.ModelAndLayerConsumer {
    ...
    public final CartesianChartRanges getRanges() {
        CartesianChartRanges cartesianChartRanges = this.ranges;
        if (cartesianChartRanges != null) {
            return cartesianChartRanges;
        }
        Intrinsics.throwUninitializedPropertyAccessException("ranges");
        return null;
    }

    public final void setRanges(CartesianChartRanges cartesianChartRanges) {
    ...
    public <T extends CartesianLayerModel> void invoke(T model, CartesianLayer<T> layer) {
        ...
        layer.prepareForTransformation(model, getRanges(), getExtraStore());
    }
}
