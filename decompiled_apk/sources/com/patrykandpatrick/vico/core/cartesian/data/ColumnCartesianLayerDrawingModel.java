...
public final class ColumnCartesianLayerDrawingModel extends CartesianLayerDrawingModel<Entry> {
    ...
    public /* synthetic */ ColumnCartesianLayerDrawingModel(List list, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public CartesianLayerDrawingModel<Entry> transform(List<? extends Map<Double, ? extends Entry>> entries, CartesianLayerDrawingModel<Entry> from, float fraction) {
        Intrinsics.checkNotNullParameter(entries, "entries");
        ColumnCartesianLayerDrawingModel columnCartesianLayerDrawingModel = (ColumnCartesianLayerDrawingModel) from;
        Float $this$orZero$iv = columnCartesianLayerDrawingModel != null ? Float.valueOf(columnCartesianLayerDrawingModel.opacity) : null;
        float oldOpacity = $this$orZero$iv != null ? $this$orZero$iv.floatValue() : 0.0f;
        return new ColumnCartesianLayerDrawingModel(entries, MathKt.lerp(oldOpacity, this.opacity, fraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ColumnCartesianLayerDrawingModel) && Intrinsics.areEqual(this.entries, ((ColumnCartesianLayerDrawingModel) other).entries)) {
            if (this.opacity == ((ColumnCartesianLayerDrawingModel) other).opacity) {
                return true;
            }
        }
        return false;
    ...
    /* compiled from: ColumnCartesianLayerDrawingModel.kt */
    @Metadata(m145d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0002\b\b\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\b\u001a\u00020\u00012\b\u0010\t\u001a\u0004\u0018\u00010\u00012\u0006\u0010\n\u001a\u00020\u0003H\u0016J\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eH\u0096\u0002J\b\u0010\u000f\u001a\u00020\u0010H\u0016R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0011"}, m146d2 = {"Lcom/patrykandpatrick/vico/core/cartesian/data/ColumnCartesianLayerDrawingModel$Entry;", "Lcom/patrykandpatrick/vico/core/common/data/CartesianLayerDrawingModel$Entry;", "height", "", "<init>", "(F)V", "getHeight", "()F", "transform", "from", "fraction", "equals", "", "other", "", "hashCode", "", "core_release"}, m147k = 1, m148mv = {2, 2, 0}, m150xi = 48)
    /* loaded from: classes14.dex */
    public static final class Entry implements CartesianLayerDrawingModel.Entry {
        private final float height;

        public Entry(float height) {
            this.height = height;
        }
        ...
        public CartesianLayerDrawingModel.Entry transform(CartesianLayerDrawingModel.Entry from, float fraction) {
            ...
            Float $this$orZero$iv = entry != null ? Float.valueOf(entry.height) : null;
            float oldHeight = $this$orZero$iv != null ? $this$orZero$iv.floatValue() : 0.0f;
            return new Entry(MathKt.lerp(oldHeight, this.height, fraction));
        }
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof Entry) {
                if (this.height == ((Entry) other).height) {
                    return true;
                }
            }
            return false;
