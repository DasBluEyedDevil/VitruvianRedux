...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (!(state instanceof CompletedContinuation)) {
                if (C0911xc40028dd.m61m(_state$volatile$FU, this, state, new CompletedContinuation(state, null, null, null, cause, 14, null))) {
                    return;
                }
            } else {
                ...
                if (C0911xc40028dd.m61m(_state$volatile$FU, this, state, update)) {
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!C0911xc40028dd.m61m(_state$volatile$FU, this, state, update));
    ...
    private final DisposableHandle installParentHandle() {
        ...
        C0911xc40028dd.m61m(_parentHandle$volatile$FU, this, null, handle);
        return handle;
    }
    ...
    private final void invokeOnCancellationImpl(Object handler) {
        ...
        while (true) {
            ...
            if (state instanceof Active) {
                if (C0911xc40028dd.m61m(_state$volatile$FU, this, state, handler)) {
                    return;
                }
                ...
                if (state instanceof CompletedContinuation) {
                    ...
                    if (C0911xc40028dd.m61m(_state$volatile$FU, this, state, update2)) {
                        return;
                    }
                }
            }
