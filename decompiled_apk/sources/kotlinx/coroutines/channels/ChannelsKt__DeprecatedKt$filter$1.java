...
@DebugMetadata(m156c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filter$1", m157f = "Deprecated.kt", m158i = {0, 1, 1, 2}, m159l = {228, 229, 229}, m160m = "invokeSuspend", m161n = {"$this$produce", "$this$produce", "e", "$this$produce"}, m163s = {"L$0", "L$0", "L$2", "L$0"})
...
public final class ChannelsKt__DeprecatedKt$filter$1<E> extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:22:0x00b0 -> B:7:0x0057). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:23:0x00b6 -> B:7:0x0057). Please report as a decompilation issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
