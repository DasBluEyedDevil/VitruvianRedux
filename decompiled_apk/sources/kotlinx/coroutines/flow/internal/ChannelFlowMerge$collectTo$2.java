...
public final class ChannelFlowMerge$collectTo$2<T> implements FlowCollector {
    ...
    */
    ...
    @DebugMetadata(m156c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m157f = "Merge.kt", m158i = {}, m159l = {65}, m160m = "invokeSuspend", m161n = {}, m163s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1 */
    /* loaded from: classes14.dex */
    public static final class C18401 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ SendingCollector<T> $collector;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C18401(Flow<? extends T> flow, SendingCollector<T> sendingCollector, Semaphore semaphore, Continuation<? super C18401> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C18401(this.$inner, this.$collector, this.$semaphore, continuation);
        }
