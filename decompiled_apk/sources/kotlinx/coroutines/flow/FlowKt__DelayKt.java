...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m11572debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m11518toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 $timeout, Object emittedItem) {
        return DelayKt.m11518toDelayMillisLRDsOJo(((Duration) $timeout.invoke(emittedItem)).getRawValue());
    }
    ...
    public static final <T> Flow<T> m11573sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m11518toDelayMillisLRDsOJo(period));
    }

    /* renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m11574timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m11575timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m11575timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
