...
public final class HashMapSerializer<K, V> extends MapLikeSerializer<K, V, Map<K, ? extends V>, HashMap<K, V>> {
    ...
    public /* bridge */ /* synthetic */ void insertKeyValuePair(Map $this$insertKeyValuePair, int index, Object obj, Object obj2) {
        insertKeyValuePair((HashMap<int, Object>) $this$insertKeyValuePair, index, (int) obj, obj2);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public void checkCapacity(HashMap<K, V> hashMap, int size) {
        Intrinsics.checkNotNullParameter(hashMap, "<this>");
    }

    protected void insertKeyValuePair(HashMap<K, V> hashMap, int index, K k, V v) {
        Intrinsics.checkNotNullParameter(hashMap, "<this>");
        hashMap.put(k, v);
    }
}
