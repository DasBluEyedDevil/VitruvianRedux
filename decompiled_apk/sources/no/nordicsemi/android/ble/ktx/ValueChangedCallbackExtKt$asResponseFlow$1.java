...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003*\b\u0012\u0004\u0012\u0002H\u00020\u0004H\n"}, m146d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lno/nordicsemi/android/ble/response/ReadResponse;", "Lkotlinx/coroutines/channels/ProducerScope;"}, m147k = 3, m148mv = {2, 2, 0}, m150xi = 176)
@DebugMetadata(m156c = "no.nordicsemi.android.ble.ktx.ValueChangedCallbackExtKt$asResponseFlow$1", m157f = "ValueChangedCallbackExt.kt", m158i = {0}, m159l = {70}, m160m = "invokeSuspend", m161n = {"$this$callbackFlow"}, m163s = {"L$0"}, m164v = 1)
            ...
            case 0:
                ...
                valueChangedCallback.with(new DataReceivedCallback() { // from class: no.nordicsemi.android.ble.ktx.ValueChangedCallbackExtKt$asResponseFlow$1.1
                    ...
                    public final void onDataReceived(BluetoothDevice device, Data data) {
                        ...
                        ReadResponse $this$onDataReceived_u24lambda_u240 = (ReadResponse) newInstance;
                        $this$onDataReceived_u24lambda_u240.onDataReceived(device, data);
                        ReadResponse response = (ReadResponse) newInstance;
                ...
                this.label = 1;
                if (ProduceKt.awaitClose($this$callbackFlow, new Function0<Unit>() { // from class: no.nordicsemi.android.ble.ktx.ValueChangedCallbackExtKt$asResponseFlow$1.2
