...
public final class C1917SegmentedByteString extends ByteString {
    ...
    public C1917SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        return new C1917SegmentedByteString(newSegments$iv, newDirectory$iv);
    }
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C1917SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C1917SegmentedByteString $this$commonWrite$iv2 = this;
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C1917SegmentedByteString $this$commonRangeEquals$iv = this;
        if (offset >= 0 && offset <= $this$commonRangeEquals$iv.size() - byteCount) {
            ...
            while (pos$iv$iv < endIndex$iv$iv) {
                ...
                C1917SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C1917SegmentedByteString $this$commonCopyInto$iv = this;
