        ...
        for (long pos$iv = 0; request(pos$iv + 1); pos$iv++) {
            ...
            if ((b$iv < 48 || b$iv > 57) && (pos$iv != 0 || b$iv != 45)) {
                if (pos$iv == 0) {
                    ...
                    String num = Integer.toString(b$iv, CharsKt.checkRadix(16));
