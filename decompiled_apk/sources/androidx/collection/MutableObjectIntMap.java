...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final int put(K key, int value, int r6) {
        int index = findIndex(key);
        int previous = r6;
        if (index < 0) {
            index = ~index;
