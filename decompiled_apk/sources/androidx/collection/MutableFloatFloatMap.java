...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public final float put(float key, float value, float r6) {
        int index = findInsertIndex(key);
        float previous = r6;
        if (index < 0) {
            index = ~index;
