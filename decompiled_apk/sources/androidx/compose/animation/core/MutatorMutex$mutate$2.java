...
@DebugMetadata(m156c = "androidx.compose.animation.core.MutatorMutex$mutate$2", m157f = "InternalMutatorMutex.kt", m158i = {0, 0, 1, 1}, m159l = {177, WebSocketProtocol.PAYLOAD_SHORT}, m160m = "invokeSuspend", m161n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m163s = {"L$0", "L$1", "L$0", "L$1"})
