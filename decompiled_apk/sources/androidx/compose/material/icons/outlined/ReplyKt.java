...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u001e\u0010\u0002\u001a\u00020\u0001*\u00020\u00038FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m146d2 = {"_reply", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Reply", "Landroidx/compose/material/icons/Icons$Outlined;", "getReply$annotations", "(Landroidx/compose/material/icons/Icons$Outlined;)V", "getReply", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, m147k = 2, m148mv = {1, 8, 0}, m150xi = 48)
...
public final class ReplyKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.p000ui.graphics.vector.ImageVector getReply(androidx.compose.material.icons.Icons.Outlined r33) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.ReplyKt._reply
            if (r0 == 0) goto La
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.ReplyKt._reply
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        La:
            java.lang.String r2 = "Outlined.Reply"
            r10 = 0
            r0 = 0
            ...
            r12.lineToRelative(r1, r1)
            r0 = -1065143501(0xffffffffc0833333, float:-4.1)
            r12.verticalLineToRelative(r0)
            r28 = 1093664768(0x41300000, float:11.0)
            r29 = 1084437299(0x40a33333, float:5.1)
            r24 = 1084227584(0x40a00000, float:5.0)
            r25 = 0
            r26 = 1091043328(0x41080000, float:8.5)
            r27 = 1070386381(0x3fcccccd, float:1.6)
            r23 = r12
            r23.curveToRelative(r24, r25, r26, r27, r28, r29)
            r28 = -1053818880(0xffffffffc1300000, float:-11.0)
            r29 = -1053818880(0xffffffffc1300000, float:-11.0)
            r24 = -1082130432(0xffffffffbf800000, float:-1.0)
            r25 = -1063256064(0xffffffffc0a00000, float:-5.0)
            r26 = -1065353216(0xffffffffc0800000, float:-4.0)
            r27 = -1054867456(0xffffffffc1200000, float:-10.0)
            r23.curveToRelative(r24, r25, r26, r27, r28, r29)
            r23.close()
            ...
            androidx.compose.material.icons.outlined.ReplyKt._reply = r0
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.ReplyKt._reply
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.outlined.ReplyKt.getReply(androidx.compose.material.icons.Icons$Outlined):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
