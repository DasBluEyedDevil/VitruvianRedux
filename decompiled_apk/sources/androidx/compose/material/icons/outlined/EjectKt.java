...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m146d2 = {"_eject", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Eject", "Landroidx/compose/material/icons/Icons$Outlined;", "getEject", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, m147k = 2, m148mv = {1, 8, 0}, m150xi = 48)
...
public final class EjectKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.p000ui.graphics.vector.ImageVector getEject(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.EjectKt._eject
            if (r0 == 0) goto La
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.EjectKt._eject
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        La:
            java.lang.String r2 = "Outlined.Eject"
            r10 = 0
            r0 = 0
            ...
            r12.moveTo(r0, r1)
            r0 = 1084919644(0x40aa8f5c, float:5.33)
            r1 = 1097859072(0x41700000, float:15.0)
            r12.lineTo(r0, r1)
            r0 = 1096118436(0x415570a4, float:13.34)
            r12.horizontalLineToRelative(r0)
            r0 = 1094713344(0x41400000, float:12.0)
            r1 = 1084227584(0x40a00000, float:5.0)
            r12.lineTo(r0, r1)
            r12.close()
            r1 = 1091148186(0x4109999a, float:8.6)
            r12.moveTo(r0, r1)
            r0 = 1077642527(0x403b851f, float:2.93)
            r1 = 1082969293(0x408ccccd, float:4.4)
            r12.lineToRelative(r0, r1)
            r0 = 1091641016(0x41111eb8, float:9.07)
            r1 = 1095761920(0x41500000, float:13.0)
            r12.lineTo(r0, r1)
            r0 = 1091148186(0x4109999a, float:8.6)
            ...
            androidx.compose.material.icons.outlined.EjectKt._eject = r0
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.EjectKt._eject
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.outlined.EjectKt.getEject(androidx.compose.material.icons.Icons$Outlined):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
