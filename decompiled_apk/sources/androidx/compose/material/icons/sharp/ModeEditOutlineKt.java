...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m146d2 = {"_modeEditOutline", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ModeEditOutline", "Landroidx/compose/material/icons/Icons$Sharp;", "getModeEditOutline", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, m147k = 2, m148mv = {1, 8, 0}, m150xi = 48)
...
public final class ModeEditOutlineKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.p000ui.graphics.vector.ImageVector getModeEditOutline(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.ModeEditOutlineKt._modeEditOutline
            if (r0 == 0) goto La
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.ModeEditOutlineKt._modeEditOutline
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        La:
            java.lang.String r2 = "Sharp.ModeEditOutline"
            r10 = 0
            r0 = 0
            ...
            r0 = 1099856609(0x418e7ae1, float:17.81)
            r1 = 1092553277(0x411f0a3d, float:9.94)
            r12.lineTo(r0, r1)
            r0 = -1066401792(0xffffffffc0700000, float:-3.75)
            r12.lineToRelative(r0, r0)
            r0 = 1077936128(0x40400000, float:3.0)
            r1 = 1099563008(0x418a0000, float:17.25)
            r12.lineTo(r0, r1)
            r12.close()
            r0 = 1101744046(0x41ab47ae, float:21.41)
            r1 = 1087037768(0x40cae148, float:6.34)
            r12.moveTo(r0, r1)
            r0 = -1066401792(0xffffffffc0700000, float:-3.75)
            r12.lineToRelative(r0, r0)
            r0 = -1071518843(0xffffffffc021eb85, float:-2.53)
            r1 = 1076006748(0x40228f5c, float:2.54)
            r12.lineToRelative(r0, r1)
            r0 = 1081081856(0x40700000, float:3.75)
            r12.lineToRelative(r0, r0)
            r0 = 1087037768(0x40cae148, float:6.34)
            ...
            androidx.compose.material.icons.sharp.ModeEditOutlineKt._modeEditOutline = r0
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.ModeEditOutlineKt._modeEditOutline
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.sharp.ModeEditOutlineKt.getModeEditOutline(androidx.compose.material.icons.Icons$Sharp):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
