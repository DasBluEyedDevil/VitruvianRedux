...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m146d2 = {"_sensorDoor", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SensorDoor", "Landroidx/compose/material/icons/Icons$Sharp;", "getSensorDoor", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, m147k = 2, m148mv = {1, 8, 0}, m150xi = 48)
...
public final class SensorDoorKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.p000ui.graphics.vector.ImageVector getSensorDoor(androidx.compose.material.icons.Icons.Sharp r33) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.SensorDoorKt._sensorDoor
            if (r0 == 0) goto La
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.SensorDoorKt._sensorDoor
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        La:
            java.lang.String r2 = "Sharp.SensorDoor"
            r10 = 0
            r0 = 0
            ...
            r12.moveTo(r0, r1)
            r28 = -1077936128(0xffffffffbfc00000, float:-1.5)
            r29 = -1077936128(0xffffffffbfc00000, float:-1.5)
            r24 = -1084982559(0xffffffffbf547ae1, float:-0.83)
            r25 = 0
            r26 = -1077936128(0xffffffffbfc00000, float:-1.5)
            r27 = -1087666913(0xffffffffbf2b851f, float:-0.67)
            r23 = r12
            ...
            r12.reflectiveCurveToRelative(r0, r2, r1, r2)
            r0 = 1093843026(0x4132b852, float:11.17)
            r1 = 1094713344(0x41400000, float:12.0)
            r2 = 1099431936(0x41880000, float:17.0)
            r12.reflectiveCurveTo(r2, r0, r2, r1)
            r0 = 1099080663(0x4182a3d7, float:16.33)
            r1 = 1098383360(0x41780000, float:15.5)
            r2 = 1096286208(0x41580000, float:13.5)
            r12.reflectiveCurveTo(r0, r2, r1, r2)
            r12.close()
            ...
            androidx.compose.material.icons.sharp.SensorDoorKt._sensorDoor = r0
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.SensorDoorKt._sensorDoor
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.sharp.SensorDoorKt.getSensorDoor(androidx.compose.material.icons.Icons$Sharp):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
