...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m146d2 = {"_carpenter", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Carpenter", "Landroidx/compose/material/icons/Icons$Sharp;", "getCarpenter", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, m147k = 2, m148mv = {1, 8, 0}, m150xi = 48)
...
public final class CarpenterKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.p000ui.graphics.vector.ImageVector getCarpenter(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.CarpenterKt._carpenter
            if (r0 == 0) goto La
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.CarpenterKt._carpenter
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        La:
            java.lang.String r2 = "Sharp.Carpenter"
            r10 = 0
            r0 = 0
            ...
            r12.moveTo(r0, r1)
            r0 = 1078397501(0x40470a3d, float:3.11)
            r1 = 1085045473(0x40ac7ae1, float:5.39)
            r12.lineTo(r0, r1)
            r0 = 1090655355(0x4102147b, float:8.13)
            r1 = 1094367314(0x413ab852, float:11.67)
            r12.lineToRelative(r0, r1)
            r0 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r1 = 1068792545(0x3fb47ae1, float:1.41)
            r12.lineToRelative(r0, r1)
            r0 = 1082633748(0x4087ae14, float:4.24)
            r12.lineToRelative(r0, r0)
            r1 = 1088568689(0x40e23d71, float:7.07)
            r0 = -1058914959(0xffffffffc0e23d71, float:-7.07)
            r12.lineToRelative(r1, r0)
            r0 = 1069547520(0x3fc00000, float:1.5)
            r1 = 1088421888(0x40e00000, float:7.0)
            r12.lineTo(r1, r0)
            r12.close()
            r0 = 1095405404(0x414a8f5c, float:12.66)
            r1 = 1100202639(0x4193c28f, float:18.47)
            r12.moveTo(r0, r1)
            r0 = -1064849900(0xffffffffc087ae14, float:-4.24)
            r1 = 1082633748(0x4087ae14, float:4.24)
            r12.lineToRelative(r1, r0)
            r0 = 1068792545(0x3fb47ae1, float:1.41)
            r12.lineToRelative(r0, r0)
            r0 = -1064849900(0xffffffffc087ae14, float:-4.24)
            r12.lineToRelative(r0, r1)
            r0 = 1100202639(0x4193c28f, float:18.47)
            r1 = 1095405404(0x414a8f5c, float:12.66)
            r12.lineTo(r1, r0)
            r12.close()
            ...
            androidx.compose.material.icons.sharp.CarpenterKt._carpenter = r0
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.CarpenterKt._carpenter
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.sharp.CarpenterKt.getCarpenter(androidx.compose.material.icons.Icons$Sharp):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
