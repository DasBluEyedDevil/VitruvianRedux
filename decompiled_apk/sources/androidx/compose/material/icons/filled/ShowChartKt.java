...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u001e\u0010\u0002\u001a\u00020\u0001*\u00020\u00038FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m146d2 = {"_showChart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ShowChart", "Landroidx/compose/material/icons/Icons$Filled;", "getShowChart$annotations", "(Landroidx/compose/material/icons/Icons$Filled;)V", "getShowChart", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, m147k = 2, m148mv = {1, 8, 0}, m150xi = 48)
...
public final class ShowChartKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.p000ui.graphics.vector.ImageVector getShowChart(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.ShowChartKt._showChart
            if (r0 == 0) goto La
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.ShowChartKt._showChart
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        La:
            java.lang.String r2 = "Filled.ShowChart"
            r10 = 0
            r0 = 0
            ...
            r29 = r1
            r1 = 1100213125(0x4193eb85, float:18.49)
            r12.moveTo(r0, r1)
            r0 = 1086324736(0x40c00000, float:6.0)
            r1 = -1061137940(0xffffffffc0c051ec, float:-6.01)
            r12.lineToRelative(r0, r1)
            r0 = 1082130432(0x40800000, float:4.0)
            r12.lineToRelative(r0, r0)
            r0 = 1102053376(0x41b00000, float:22.0)
            r1 = 1088254116(0x40dd70a4, float:6.92)
            r12.lineTo(r0, r1)
            r0 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r12.lineToRelative(r0, r0)
            r0 = -1058873016(0xffffffffc0e2e148, float:-7.09)
            r1 = 1090456125(0x40ff0a3d, float:7.97)
            r12.lineToRelative(r0, r1)
            r0 = -1065353216(0xffffffffc0800000, float:-4.0)
            r12.lineToRelative(r0, r0)
            r0 = 1073741824(0x40000000, float:2.0)
            r1 = 1099426693(0x4187eb85, float:16.99)
            r12.lineTo(r0, r1)
            r12.close()
            ...
            androidx.compose.material.icons.filled.ShowChartKt._showChart = r0
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.ShowChartKt._showChart
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.ShowChartKt.getShowChart(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
