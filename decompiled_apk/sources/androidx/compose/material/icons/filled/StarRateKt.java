...
@Metadata(m145d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m146d2 = {"_starRate", "Landroidx/compose/ui/graphics/vector/ImageVector;", "StarRate", "Landroidx/compose/material/icons/Icons$Filled;", "getStarRate", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, m147k = 2, m148mv = {1, 8, 0}, m150xi = 48)
...
public final class StarRateKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.p000ui.graphics.vector.ImageVector getStarRate(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.StarRateKt._starRate
            if (r0 == 0) goto La
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.StarRateKt._starRate
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        La:
            java.lang.String r2 = "Filled.StarRate"
            r10 = 0
            r0 = 0
            ...
            r23 = 0
            r28 = r0
            r0 = 1097261384(0x4166e148, float:14.43)
            r29 = r1
            r1 = 1092616192(0x41200000, float:10.0)
            r12.moveTo(r0, r1)
            r0 = -1056964608(0xffffffffc1000000, float:-8.0)
            r1 = -1071938273(0xffffffffc01b851f, float:-2.43)
            r12.lineToRelative(r1, r0)
            r0 = 1090519040(0x41000000, float:8.0)
            r12.lineToRelative(r1, r0)
            r0 = -1057866383(0xffffffffc0f23d71, float:-7.57)
            r1 = 0
            r12.lineToRelative(r0, r1)
            r0 = 1082990264(0x408d1eb8, float:4.41)
            r1 = 1086702223(0x40c5c28f, float:6.18)
            r12.lineToRelative(r1, r0)
            r0 = 1089659208(0x40f2e148, float:7.59)
            r1 = -1072273818(0xffffffffc0166666, float:-2.35)
            r12.lineToRelative(r1, r0)
            r0 = -1063906181(0xffffffffc096147b, float:-4.69)
            r1 = 1086681252(0x40c570a4, float:6.17)
            r12.lineToRelative(r1, r0)
            r0 = 1083577467(0x4096147b, float:4.69)
            r1 = 1086702223(0x40c5c28f, float:6.18)
            r12.lineToRelative(r1, r0)
            r0 = -1057824440(0xffffffffc0f2e148, float:-7.59)
            r1 = -1072273818(0xffffffffc0166666, float:-2.35)
            r12.lineToRelative(r1, r0)
            r0 = -1064493384(0xffffffffc08d1eb8, float:-4.41)
            r1 = 1086681252(0x40c570a4, float:6.17)
            r12.lineToRelative(r1, r0)
            r12.close()
            ...
            androidx.compose.material.icons.filled.StarRateKt._starRate = r0
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.StarRateKt._starRate
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.StarRateKt.getStarRate(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
