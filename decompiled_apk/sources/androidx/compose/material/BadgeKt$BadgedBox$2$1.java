...
final class BadgeKt$BadgedBox$2$1 implements MeasurePolicy {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "badge")) {
                ...
                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "anchor")) {
                        ...
                        return $this$Layout.layout(totalWidth, totalHeight, MapsKt.mapOf(TuplesKt.m153to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(firstBaseline)), TuplesKt.m153to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(lastBaseline))), new Function1() { // from class: androidx.compose.material.BadgeKt$BadgedBox$2$1$$ExternalSyntheticLambda0
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                Unit measure_3p2s80s$lambda$2;
                                measure_3p2s80s$lambda$2 = BadgeKt$BadgedBox$2$1.measure_3p2s80s$lambda$2(Placeable.this, $this$Layout, anchorPlaceable, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$2(Placeable $badgePlaceable, MeasureScope $this_Layout, Placeable $anchorPlaceable, Placeable.PlacementScope $this$layout) {
        boolean hasContent = $badgePlaceable.getWidth() > $this_Layout.mo645roundToPx0680j_4(BadgeKt.getBadgeRadius()) * 2;
        ...
        int badgeX = $anchorPlaceable.getWidth() + $this_Layout.mo645roundToPx0680j_4(badgeHorizontalOffset);
