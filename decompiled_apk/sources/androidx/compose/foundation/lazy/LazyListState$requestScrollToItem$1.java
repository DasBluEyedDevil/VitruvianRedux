...
@DebugMetadata(m156c = "androidx.compose.foundation.lazy.LazyListState$requestScrollToItem$1", m157f = "LazyListState.kt", m158i = {}, m159l = {395}, m160m = "invokeSuspend", m161n = {}, m163s = {})
...
final class LazyListState$requestScrollToItem$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m156c = "androidx.compose.foundation.lazy.LazyListState$requestScrollToItem$1$1", m157f = "LazyListState.kt", m158i = {}, m159l = {}, m160m = "invokeSuspend", m161n = {}, m163s = {})
    /* renamed from: androidx.compose.foundation.lazy.LazyListState$requestScrollToItem$1$1 */
    /* loaded from: classes.dex */
    public static final class C02671 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02671(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(ScrollScope scrollScope, Continuation<? super Unit> continuation) {
            return ((C02671) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (ScrollableState.scroll$default(this.this$0, null, new C02671(null), this, 1, null) == coroutine_suspended) {
