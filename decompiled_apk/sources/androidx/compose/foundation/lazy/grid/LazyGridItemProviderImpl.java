...
public final class LazyGridItemProviderImpl implements LazyGridItemProvider {
    ...
    public void Item(final int index, Object key, Composer $composer, final int $changed) {
        ...
        if (!$composer2.shouldExecute(($dirty & GattError.GATT_TIMEOUT) != 146, $dirty & 1)) {
            ...
            index2 = index;
            key2 = key;
            LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key2, index2, this.state.getPinnedItems(), ComposableLambdaKt.rememberComposableLambda(726189336, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C*82@3156L39:LazyGridItemProvider.kt#7791vq");
                    if ($composer3.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(726189336, $changed2, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item.<anonymous> (LazyGridItemProvider.kt:81)");
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    Unit Item$lambda$0;
                    Item$lambda$0 = LazyGridItemProviderImpl.Item$lambda$0(LazyGridItemProviderImpl.this, index2, key2, $changed, (Composer) obj, ((Integer) obj2).intValue());
