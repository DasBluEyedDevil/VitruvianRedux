...
public final class DefaultPagerState extends PagerState {
    ...
    }, new Function1() { // from class: androidx.compose.foundation.pager.DefaultPagerState$$ExternalSyntheticLambda2
    ...
    /* compiled from: PagerState.kt */
    @Metadata(m145d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001b\u0010\u0004\u001a\f\u0012\u0004\u0012\u00020\u0006\u0012\u0002\b\u00030\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, m146d2 = {"Landroidx/compose/foundation/pager/DefaultPagerState$Companion;", "", "<init>", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/pager/DefaultPagerState;", "getSaver", "()Landroidx/compose/runtime/saveable/Saver;", "foundation_release"}, m147k = 1, m148mv = {2, 0, 0}, m150xi = 48)
    /* loaded from: classes.dex */
    ...
    public static final List Saver$lambda$0(SaverScope $this$listSaver, DefaultPagerState it) {
        return CollectionsKt.listOf(Integer.valueOf(it.getCurrentPage()), Float.valueOf(RangesKt.coerceIn(it.getCurrentPageOffsetFraction(), -0.5f, 0.5f)), Integer.valueOf(it.getPageCount()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final DefaultPagerState Saver$lambda$2(final List it) {
        Object obj = it.get(0);
        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Int");
        int intValue = ((Integer) obj).intValue();
        Object obj2 = it.get(1);
        Intrinsics.checkNotNull(obj2, "null cannot be cast to non-null type kotlin.Float");
        return new DefaultPagerState(intValue, ((Float) obj2).floatValue(), new Function0() { // from class: androidx.compose.foundation.pager.DefaultPagerState$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                int Saver$lambda$2$lambda$1;
                Saver$lambda$2$lambda$1 = DefaultPagerState.Saver$lambda$2$lambda$1(it);
