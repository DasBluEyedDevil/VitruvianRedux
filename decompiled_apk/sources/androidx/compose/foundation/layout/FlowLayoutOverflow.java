...
public abstract class FlowLayoutOverflow {
    ...
    public final void addOverflowComposables$foundation_layout(FlowLayoutOverflowState state, List<Function2<Composer, Integer, Unit>> list) {
        Function1 getter = this.seeMoreGetter;
        Function2<Composer, Integer, Unit> expandIndicator = getter != null ? getter.invoke(state) : null;
        Function1 getter2 = this.collapseGetter;
        Function2<Composer, Integer, Unit> collapseIndicator = getter2 != null ? getter2.invoke(state) : null;
        switch (WhenMappings.$EnumSwitchMapping$0[this.type.ordinal()]) {
            case 1:
                if (expandIndicator != null) {
                    list.add(expandIndicator);
                    return;
                }
                return;
            case 2:
    ...
    /* compiled from: FlowLayoutOverflow.kt */
    @Metadata(m145d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0080\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, m146d2 = {"Landroidx/compose/foundation/layout/FlowLayoutOverflow$OverflowType;", "", "<init>", "(Ljava/lang/String;I)V", "Visible", "Clip", "ExpandIndicator", "ExpandOrCollapseIndicator", "foundation-layout"}, m147k = 1, m148mv = {2, 0, 0}, m150xi = 48)
    /* loaded from: classes.dex */
