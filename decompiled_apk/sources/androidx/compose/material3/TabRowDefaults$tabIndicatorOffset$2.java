...
final class TabRowDefaults$tabIndicatorOffset$2 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
        ...
        State currentTabWidth$delegate = AnimateAsStateKt.m372animateDpAsStateAjpBEmI(this.$currentTabPosition.getWidth(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, $composer, 6), null, null, $composer, 0, 12);
        final State indicatorOffset$delegate = AnimateAsStateKt.m372animateDpAsStateAjpBEmI(this.$currentTabPosition.getLeft(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, $composer, 6), null, null, $composer, 0, 12);
