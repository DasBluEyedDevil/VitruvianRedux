...
public final class ChipColors {
    ...
    public static /* synthetic */ ChipColors m2668copyFD3wquc$default(ChipColors chipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, int i, Object obj) {
        long j9;
        long j10;
        ...
        return chipColors.m2670copyFD3wquc(j9, j12, j13, j14, j15, j16, j17, j10);
    }

    /* renamed from: copy-FD3wquc, reason: not valid java name */
    public final ChipColors m2670copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
    ...
    public final long m2669containerColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m2679labelColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m2680leadingIconContentColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m2681trailingIconContentColorvNxB06k$material3(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipColors) && Color.m5886equalsimpl0(this.containerColor, ((ChipColors) other).containerColor) && Color.m5886equalsimpl0(this.labelColor, ((ChipColors) other).labelColor) && Color.m5886equalsimpl0(this.leadingIconContentColor, ((ChipColors) other).leadingIconContentColor) && Color.m5886equalsimpl0(this.trailingIconContentColor, ((ChipColors) other).trailingIconContentColor) && Color.m5886equalsimpl0(this.disabledContainerColor, ((ChipColors) other).disabledContainerColor) && Color.m5886equalsimpl0(this.disabledLabelColor, ((ChipColors) other).disabledLabelColor) && Color.m5886equalsimpl0(this.disabledLeadingIconContentColor, ((ChipColors) other).disabledLeadingIconContentColor) && Color.m5886equalsimpl0(this.disabledTrailingIconContentColor, ((ChipColors) other).disabledTrailingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((result * 31) + Color.m5892hashCodeimpl(this.labelColor)) * 31) + Color.m5892hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m5892hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m5892hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m5892hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m5892hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m5892hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
