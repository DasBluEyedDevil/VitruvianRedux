...
public final class ListItemColors {
    ...
    public final long m3142getContainerColor0d7_KjU() {
    ...
    public static /* synthetic */ ListItemColors m3139copy5r9EGqc$default(ListItemColors listItemColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, int i, Object obj) {
        long j10;
        long j11;
        ...
        if ((i & 256) != 0) {
            j10 = j20;
            j11 = listItemColors.disabledTrailingIconColor;
        } else {
            j10 = j20;
            j11 = j9;
        }
        return listItemColors.m3141copy5r9EGqc(j19, j13, j14, j15, j16, j17, j18, j10, j11);
    }

    /* renamed from: copy-5r9EGqc, reason: not valid java name */
    public final ListItemColors m3141copy5r9EGqc(long containerColor, long headlineColor, long leadingIconColor, long overlineColor, long supportingTextColor, long trailingIconColor, long disabledHeadlineColor, long disabledLeadingIconColor, long disabledTrailingIconColor) {
        return new ListItemColors((containerColor > 16L ? 1 : (containerColor == 16L ? 0 : -1)) != 0 ? containerColor : this.containerColor, (headlineColor > 16L ? 1 : (headlineColor == 16L ? 0 : -1)) != 0 ? headlineColor : this.headlineColor, (leadingIconColor > 16L ? 1 : (leadingIconColor == 16L ? 0 : -1)) != 0 ? leadingIconColor : this.leadingIconColor, (overlineColor > 16L ? 1 : (overlineColor == 16L ? 0 : -1)) != 0 ? overlineColor : this.overlineColor, (supportingTextColor > 16L ? 1 : (supportingTextColor == 16L ? 0 : -1)) != 0 ? supportingTextColor : this.supportingTextColor, (trailingIconColor > 16L ? 1 : (trailingIconColor == 16L ? 0 : -1)) != 0 ? trailingIconColor : this.trailingIconColor, (disabledHeadlineColor > 16L ? 1 : (disabledHeadlineColor == 16L ? 0 : -1)) != 0 ? disabledHeadlineColor : this.disabledHeadlineColor, (disabledLeadingIconColor > 16L ? 1 : (disabledLeadingIconColor == 16L ? 0 : -1)) != 0 ? disabledLeadingIconColor : this.disabledLeadingIconColor, disabledTrailingIconColor != 16 ? disabledTrailingIconColor : this.disabledTrailingIconColor, null);
    }
    ...
    public final long m3151headlineColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m3152leadingIconColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m3153overlineColor0d7_KjU$material3() {
        return this.overlineColor;
    }

    /* renamed from: supportingColor-0d7_KjU$material3, reason: not valid java name */
    public final long m3154supportingColor0d7_KjU$material3() {
        return this.supportingTextColor;
    }

    /* renamed from: trailingIconColor-vNxB06k$material3, reason: not valid java name */
    public final long m3155trailingIconColorvNxB06k$material3(boolean enabled) {
