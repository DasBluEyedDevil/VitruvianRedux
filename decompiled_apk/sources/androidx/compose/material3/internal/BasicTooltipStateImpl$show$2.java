...
@DebugMetadata(m156c = "androidx.compose.material3.internal.BasicTooltipStateImpl$show$2", m157f = "BasicTooltip.kt", m158i = {}, m159l = {410, 412}, m160m = "invokeSuspend", m161n = {}, m163s = {})
...
final class BasicTooltipStateImpl$show$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!this.this$0.getIsPersistent()) {
                        this.label = 2;
                        if (TimeoutKt.withTimeout(1500L, new C07661(this.$cancellableShow, null), this) == coroutine_suspended) {
    ...
    @DebugMetadata(m156c = "androidx.compose.material3.internal.BasicTooltipStateImpl$show$2$1", m157f = "BasicTooltip.kt", m158i = {}, m159l = {412}, m160m = "invokeSuspend", m161n = {}, m163s = {})
    ...
    public static final class C07661 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C07661(Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super C07661> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C07661(this.$cancellableShow, continuation);
        }
