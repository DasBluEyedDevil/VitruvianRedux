...
public final class ElevationKt {
    ...
    private static final TweenSpec<C0897Dp> DefaultOutgoingSpec = new TweenSpec<>(androidx.compose.material.TextFieldImplKt.AnimationDuration, 0, OutgoingSpecEasing, 2, null);
    private static final TweenSpec<C0897Dp> HoveredOutgoingSpec = new TweenSpec<>(MenuKt.InTransitionDuration, 0, OutgoingSpecEasing, 2, null);

    /* renamed from: animateElevation-rAjV9yQ$default, reason: not valid java name */
    public static /* synthetic */ Object m4167animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m4166animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* renamed from: animateElevation-rAjV9yQ, reason: not valid java name */
    public static final Object m4166animateElevationrAjV9yQ(Animatable<C0897Dp, ?> animatable, float target, Interaction from, Interaction to, Continuation<? super Unit> continuation) {
