...
public final class DraggableAnchorsNodeV2<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo302measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if (!$this$measure_u2d3p2s80s.isLookingAhead() || !this.didLookahead) {
            ...
            long size = IntSize.m8795constructorimpl((width$iv << 32) | (height$iv & 4294967295L));
            Pair newAnchorResult = this.anchors.invoke(IntSize.m8792boximpl(size), Constraints.m8569boximpl(constraints));
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNodeV2$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                ...
                measure_3p2s80s$lambda$1 = DraggableAnchorsNodeV2.measure_3p2s80s$lambda$1(MeasureScope.this, this, placeable, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$1(MeasureScope measureScope, DraggableAnchorsNodeV2 draggableAnchorsNodeV2, final Placeable placeable, Placeable.PlacementScope placementScope) {
        ...
        final float f = draggableAnchorsNodeV2.orientation == Orientation.Horizontal ? requireOffset * (draggableAnchorsNodeV2.isReverseDirection() ? -1.0f : 1.0f) : 0.0f;
        final float f2 = draggableAnchorsNodeV2.orientation == Orientation.Vertical ? requireOffset : 0.0f;
        placementScope.withMotionFrameOfReferencePlacement(new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNodeV2$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj) {
                ...
                measure_3p2s80s$lambda$1$lambda$0 = DraggableAnchorsNodeV2.measure_3p2s80s$lambda$1$lambda$0(Placeable.this, f, f2, (Placeable.PlacementScope) obj);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit measure_3p2s80s$lambda$1$lambda$0(Placeable $placeable, float $xOffset, float $yOffset, Placeable.PlacementScope $this$withMotionFrameOfReferencePlacement) {
