...
final class CarouselKt$Carousel$2 implements Function4<PagerScope, Integer, Composer, Integer, Unit> {
    ...
    */
    public final void invoke(androidx.compose.foundation.pager.PagerScope r30, int r31, androidx.compose.runtime.Composer r32, int r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.carousel.CarouselKt$Carousel$2.invoke(androidx.compose.foundation.pager.PagerScope, int, androidx.compose.runtime.Composer, int):void");
    }
}
