...
public final class FloatingToolbarTokens {
    ...
    private static final float ContainerBetweenSpace = C0897Dp.m8629constructorimpl((float) 4.0d);
    private static final float ContainerExternalPadding = C0897Dp.m8629constructorimpl((float) 16.0d);
    private static final float ContainerHeight = C0897Dp.m8629constructorimpl((float) 64.0d);
    private static final float ContainerLeadingSpace = C0897Dp.m8629constructorimpl((float) 8.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerFull;
    private static final float ContainerTrailingSpace = C0897Dp.m8629constructorimpl((float) 8.0d);
    ...
    public final float m4645getContainerTrailingSpaceD9Ej5fM() {
