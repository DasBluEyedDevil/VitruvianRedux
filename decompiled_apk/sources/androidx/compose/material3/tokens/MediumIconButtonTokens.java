...
public final class MediumIconButtonTokens {
    ...
    private static final float DefaultLeadingSpace = C0897Dp.m8629constructorimpl((float) 16.0d);
    private static final float DefaultTrailingSpace = C0897Dp.m8629constructorimpl((float) 16.0d);
    private static final float IconSize = C0897Dp.m8629constructorimpl((float) 24.0d);
    private static final float NarrowLeadingSpace = C0897Dp.m8629constructorimpl((float) 12.0d);
    private static final float NarrowTrailingSpace = C0897Dp.m8629constructorimpl((float) 12.0d);
    private static final float OutlinedOutlineWidth = C0897Dp.m8629constructorimpl((float) 1.0d);
    ...
    private static final float WideLeadingSpace = C0897Dp.m8629constructorimpl((float) 24.0d);
    private static final float WideTrailingSpace = C0897Dp.m8629constructorimpl((float) 24.0d);

    private MediumIconButtonTokens() {
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4693getContainerHeightD9Ej5fM() {
    ...
    public final float m4694getDefaultLeadingSpaceD9Ej5fM() {
        return DefaultLeadingSpace;
    }

    /* renamed from: getDefaultTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4695getDefaultTrailingSpaceD9Ej5fM() {
    ...
    public final float m4700getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4701getWideTrailingSpaceD9Ej5fM() {
