...
public final class ButtonLargeTokens {
    ...
    private static final float IconLabelSpace = C0897Dp.m8629constructorimpl((float) 12.0d);
    private static final float IconSize = C0897Dp.m8629constructorimpl((float) 32.0d);
    private static final float LeadingSpace = C0897Dp.m8629constructorimpl((float) 48.0d);
    private static final float OutlinedOutlineWidth = C0897Dp.m8629constructorimpl((float) 2.0d);
    ...
    private static final float TrailingSpace = C0897Dp.m8629constructorimpl((float) 48.0d);

    private ButtonLargeTokens() {
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4322getContainerHeightD9Ej5fM() {
    ...
    public final float m4323getIconLabelSpaceD9Ej5fM() {
        return IconLabelSpace;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m4324getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getLeadingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4325getLeadingSpaceD9Ej5fM() {
        return LeadingSpace;
    }

    /* renamed from: getOutlinedOutlineWidth-D9Ej5fM, reason: not valid java name */
    public final float m4326getOutlinedOutlineWidthD9Ej5fM() {
    ...
    public final float m4327getTrailingSpaceD9Ej5fM() {
