...
public final class FabMenuBaselineTokens {
    ...
    private static final float CloseButtonBetweenSpace = C0897Dp.m8629constructorimpl((float) 8.0d);
    private static final float CloseButtonContainerElevation = ElevationTokens.INSTANCE.m4532getLevel3D9Ej5fM();
    private static final float CloseButtonContainerHeight = C0897Dp.m8629constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens CloseButtonContainerShape = ShapeKeyTokens.CornerFull;
    private static final float CloseButtonContainerWidth = C0897Dp.m8629constructorimpl((float) 56.0d);
    private static final float CloseButtonIconSize = C0897Dp.m8629constructorimpl((float) 20.0d);
    private static final float ListItemBetweenSpace = C0897Dp.m8629constructorimpl((float) 4.0d);
    private static final float ListItemContainerElevation = ElevationTokens.INSTANCE.m4532getLevel3D9Ej5fM();
    private static final float ListItemContainerHeight = C0897Dp.m8629constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ListItemContainerShape = ShapeKeyTokens.CornerFull;
    private static final float ListItemIconLabelSpace = C0897Dp.m8629constructorimpl((float) 8.0d);
    private static final float ListItemIconSize = C0897Dp.m8629constructorimpl((float) 24.0d);
    private static final float ListItemLeadingSpace = C0897Dp.m8629constructorimpl((float) 24.0d);
    private static final float ListItemTrailingSpace = C0897Dp.m8629constructorimpl((float) 24.0d);

    private FabMenuBaselineTokens() {
    }

    /* renamed from: getCloseButtonBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m4569getCloseButtonBetweenSpaceD9Ej5fM() {
        return CloseButtonBetweenSpace;
    }

    /* renamed from: getCloseButtonContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m4570getCloseButtonContainerElevationD9Ej5fM() {
        return CloseButtonContainerElevation;
    }

    /* renamed from: getCloseButtonContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4571getCloseButtonContainerHeightD9Ej5fM() {
