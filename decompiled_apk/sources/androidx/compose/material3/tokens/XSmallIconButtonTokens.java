...
public final class XSmallIconButtonTokens {
    ...
    private static final float DefaultLeadingSpace = C0897Dp.m8629constructorimpl((float) 6.0d);
    private static final float DefaultTrailingSpace = C0897Dp.m8629constructorimpl((float) 6.0d);
    private static final float IconSize = C0897Dp.m8629constructorimpl((float) 20.0d);
    private static final float NarrowLeadingSpace = C0897Dp.m8629constructorimpl((float) 4.0d);
    private static final float NarrowTrailingSpace = C0897Dp.m8629constructorimpl((float) 4.0d);
    ...
    private static final float WideLeadingSpace = C0897Dp.m8629constructorimpl((float) 10.0d);
    private static final float WideTrailingSpace = C0897Dp.m8629constructorimpl((float) 10.0d);
    ...
    public final float m5106getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5107getWideTrailingSpaceD9Ej5fM() {
