...
public final class SplitButtonXSmallTokens {
    ...
    private static final float LeadingButtonLeadingSpace = C0897Dp.m8629constructorimpl((float) 12.0d);
    private static final float LeadingButtonTrailingSpace = C0897Dp.m8629constructorimpl((float) 10.0d);
    private static final float OuterCornerCornerSizePercent = 50.0f;
    private static final float TrailingIconSize = C0897Dp.m8629constructorimpl((float) 22.0d);
    private static final float TrailingInnerSelectedCornerCornerSizePercent = 50.0f;
    private static final float TrailingButtonLeadingSpace = C0897Dp.m8629constructorimpl((float) 13.0d);
    private static final float TrailingButtonTrailingSpace = C0897Dp.m8629constructorimpl((float) 13.0d);

    private SplitButtonXSmallTokens() {
    }

    /* renamed from: getBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m4944getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4945getContainerHeightD9Ej5fM() {
    ...
    public final float m4946getLeadingButtonLeadingSpaceD9Ej5fM() {
        return LeadingButtonLeadingSpace;
    }

    /* renamed from: getLeadingButtonTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4947getLeadingButtonTrailingSpaceD9Ej5fM() {
    ...
    public final float m4950getTrailingIconSizeD9Ej5fM() {
    ...
    public final float m4948getTrailingButtonLeadingSpaceD9Ej5fM() {
        return TrailingButtonLeadingSpace;
    }

    /* renamed from: getTrailingButtonTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4949getTrailingButtonTrailingSpaceD9Ej5fM() {
