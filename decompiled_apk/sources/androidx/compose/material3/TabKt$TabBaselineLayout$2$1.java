    ...
    public final MeasureResult mo274measure3p2s80s(final MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
        ...
        if (it != null) {
            ...
            while (index$iv$iv < size) {
                Object item$iv$iv2 = list.get(index$iv$iv);
                Function2 it2 = it;
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) item$iv$iv2), "text")) {
                    ...
                    textPlaceable = ((Measurable) item$iv$iv2).mo7303measureBRTryo0(m8571copyZbe2FdA);
                } else {
                    index$iv$iv++;
                    it = it2;
                }
        ...
        if (this.$icon != null) {
            ...
            while (index$iv$iv2 < size2) {
                item$iv$iv = list.get(index$iv$iv2);
                String str2 = str;
                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) item$iv$iv), "icon")) {
                    iconPlaceable = ((Measurable) item$iv$iv).mo7303measureBRTryo0(constraints);
                } else {
                    index$iv$iv2++;
                    str = str2;
                }
        ...
        int specHeight = $this$Layout.mo645roundToPx0680j_4((textPlaceable == null || iconPlaceable == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight);
        ...
        final int tabHeight = Math.max(specHeight, height + height2 + $this$Layout.mo644roundToPxR2X_6o(j));
