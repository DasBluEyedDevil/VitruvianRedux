...
public final class IconButtonColors {
    ...
    public final IconButtonColors m3061copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m3059containerColorvNxB06k$material3(boolean enabled) {
    ...
    public final long m3060contentColorvNxB06k$material3(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconButtonColors) && Color.m5886equalsimpl0(this.containerColor, ((IconButtonColors) other).containerColor) && Color.m5886equalsimpl0(this.contentColor, ((IconButtonColors) other).contentColor) && Color.m5886equalsimpl0(this.disabledContainerColor, ((IconButtonColors) other).disabledContainerColor) && Color.m5886equalsimpl0(this.disabledContentColor, ((IconButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
