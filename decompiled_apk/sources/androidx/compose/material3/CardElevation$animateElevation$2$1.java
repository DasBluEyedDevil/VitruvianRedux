...
@DebugMetadata(m156c = "androidx.compose.material3.CardElevation$animateElevation$2$1", m157f = "Card.kt", m158i = {}, m159l = {727, 737}, m160m = "invokeSuspend", m161n = {}, m163s = {})
...
public final class CardElevation$animateElevation$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CardElevation$animateElevation$2$1(Animatable<C0897Dp, AnimationVector1D> animatable, float f, boolean z, CardElevation cardElevation, Interaction interaction, Continuation<? super CardElevation$animateElevation$2$1> continuation) {
                ...
                if (!C0897Dp.m8634equalsimpl0(this.$animatable.getTargetValue().m8643unboximpl(), this.$target)) {
                    if (!this.$enabled) {
                        ...
                        if (C0897Dp.m8634equalsimpl0(m8643unboximpl, f)) {
                            start = new PressInteraction.Press(Offset.INSTANCE.m5657getZeroF1C5BW0(), null);
                        } else {
                            ...
                            if (C0897Dp.m8634equalsimpl0(m8643unboximpl, f2)) {
                                ...
                                if (C0897Dp.m8634equalsimpl0(m8643unboximpl, f3)) {
                                    ...
                                    if (C0897Dp.m8634equalsimpl0(m8643unboximpl, f4)) {
                        ...
                        this.label = 2;
                        if (ElevationKt.m4166animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                }
