...
public final class RippleKt {
    ...
    public static /* synthetic */ IndicationNodeFactory m3421rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m3420rippleH2RKhps(z, f, j);
    }

    /* renamed from: ripple-H2RKhps */
    public static final IndicationNodeFactory m3420rippleH2RKhps(boolean bounded, float radius, long color) {
    ...
    public static /* synthetic */ IndicationNodeFactory m3423ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m3422ripplewH6b6FI(colorProducer, z, f);
    }

    /* renamed from: ripple-wH6b6FI */
    public static final IndicationNodeFactory m3422ripplewH6b6FI(ColorProducer color, boolean bounded, float radius) {
        return new RippleNodeFactory(bounded, radius, color, (DefaultConstructorMarker) null);
    }
