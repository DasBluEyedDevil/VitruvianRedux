...
public final class CardElevation {
    ...
    public final State<C0897Dp> shadowElevation$material3(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (interactionSource == null) {
            ...
            if (it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(C0897Dp.m8627boximpl(this.defaultElevation), null, 2, null);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardElevation) && C0897Dp.m8634equalsimpl0(this.defaultElevation, ((CardElevation) other).defaultElevation) && C0897Dp.m8634equalsimpl0(this.pressedElevation, ((CardElevation) other).pressedElevation) && C0897Dp.m8634equalsimpl0(this.focusedElevation, ((CardElevation) other).focusedElevation) && C0897Dp.m8634equalsimpl0(this.hoveredElevation, ((CardElevation) other).hoveredElevation) && C0897Dp.m8634equalsimpl0(this.disabledElevation, ((CardElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
