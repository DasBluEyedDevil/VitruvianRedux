...
@DebugMetadata(m156c = "androidx.compose.material3.SnackbarHostState", m157f = "SnackbarHost.kt", m158i = {0, 0, 1, 1, 1}, m159l = {428, 431}, m160m = "showSnackbar", m161n = {"visuals", "$this$withLock_u24default$iv", "visuals", "$this$withLock_u24default$iv", "$completion$iv"}, m163s = {"L$0", "L$1", "L$0", "L$1", "L$2"})
