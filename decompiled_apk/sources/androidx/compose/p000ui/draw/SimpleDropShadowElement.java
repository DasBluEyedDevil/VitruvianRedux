...
public final /* data */ class SimpleDropShadowElement extends ModifierNodeElement<SimpleDropShadowNode> {
    ...
    public static /* synthetic */ SimpleDropShadowElement copy$default(SimpleDropShadowElement simpleDropShadowElement, Shape shape, ShadowParams shadowParams, int i, Object obj) {
        if ((i & 1) != 0) {
            shape = simpleDropShadowElement.shape;
        }
        if ((i & 2) != 0) {
            shadowParams = simpleDropShadowElement.shadow;
        }
        return simpleDropShadowElement.copy(shape, shadowParams);
    }
    ...
    public final SimpleDropShadowElement copy(Shape shape, ShadowParams shadow) {
    ...
    public SimpleDropShadowElement(Shape shape, ShadowParams shadow) {
        this.shape = shape;
        this.shadow = shadow;
    }
