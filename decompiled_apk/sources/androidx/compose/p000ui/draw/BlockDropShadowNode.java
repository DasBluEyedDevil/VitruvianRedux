...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    public boolean equals(Object other) {
        ...
        if (z3 && Offset.m5638equalsimpl0(getOffset(), ((BlockDropShadowNode) other).getOffset()) && Color.m5886equalsimpl0(getColor(), ((BlockDropShadowNode) other).getColor()) && Intrinsics.areEqual(getBrush(), ((BlockDropShadowNode) other).getBrush()) && BlendMode.m5795equalsimpl0(getBlendMode(), ((BlockDropShadowNode) other).getBlendMode())) {
            return true;
        }
        return false;
    }
