...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final Modifier modifier, Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(SubcomposeLayout)P(1)94@4643L36,93@4609L145:SubcomposeLayout.kt#80mrfh");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (!$composer2.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1298353104, $dirty, -1, "androidx.compose.ui.layout.SubcomposeLayout (SubcomposeLayout.kt:92)");
            }
            ComposerKt.sourceInformationMarkerStart($composer2, 2118156148, "CC(remember):SubcomposeLayout.kt#9igjgp");
            ...
            measurePolicy = function2;
            SubcomposeLayout((SubcomposeLayoutState) it$iv, modifier2, measurePolicy, $composer2, (($dirty << 3) & 112) | (($dirty << 3) & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    */
    public static final void SubcomposeLayout(final androidx.compose.p000ui.layout.SubcomposeLayoutState r20, androidx.compose.p000ui.Modifier r21, final kotlin.jvm.functions.Function2<? super androidx.compose.p000ui.layout.SubcomposeMeasureScope, ? super androidx.compose.p000ui.unit.Constraints, ? extends androidx.compose.p000ui.layout.MeasureResult> r22, androidx.compose.runtime.Composer r23, final int r24, final int r25) {
        /*
            Method dump skipped, instructions count: 433
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p000ui.layout.SubcomposeLayoutKt.SubcomposeLayout(androidx.compose.ui.layout.SubcomposeLayoutState, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
