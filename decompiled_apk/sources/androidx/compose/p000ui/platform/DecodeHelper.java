...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte == 1) {
                ...
                mutableSpanStyle.m7768setColor8_81llA(m7725decodeColor0d7_KjU());
            } else if (decodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m7769setFontSizeR2X_6o(m7728decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m7770setFontStylemLjRB2g(FontStyle.m8173boximpl(m7726decodeFontStyle_LCdwA()));
            } else if (decodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m7771setFontSynthesistDdu0R4(FontSynthesis.m8184boximpl(m7727decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m7772setLetterSpacingR2X_6o(m7728decodeTextUnitXSAIIZE());
            } else if (decodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m7767setBaselineShift_isdbwI(BaselineShift.m8357boximpl(m7723decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m7766setBackground8_81llA(m7725decodeColor0d7_KjU());
    ...
    public final int m7726decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
    ...
    public final int m7727decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
    ...
    private final float m7723decodeBaselineShifty9eOQZs() {
    ...
    private final Shadow decodeShadow() {
        long m7725decodeColor0d7_KjU = m7725decodeColor0d7_KjU();
        float x$iv = decodeFloat();
        float y$iv = decodeFloat();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new Shadow(m7725decodeColor0d7_KjU, Offset.m5633constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), decodeFloat(), null);
    }
    ...
    private final long m7724decodeULongsVKNKU() {
