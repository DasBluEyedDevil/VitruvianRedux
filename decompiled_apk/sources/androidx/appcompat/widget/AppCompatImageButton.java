...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatImageButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mTintId = propertyMapper.mapObject("tint", C0019R.attr.tint);
            this.mTintModeId = propertyMapper.mapObject("tintMode", C0019R.attr.tintMode);
    ...
    public AppCompatImageButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0019R.attr.imageButtonStyle);
    }
