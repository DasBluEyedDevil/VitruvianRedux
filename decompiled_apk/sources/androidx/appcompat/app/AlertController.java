...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0019R.attr.alertDialogCenterButtons, outValue, true);
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0019R.styleable.AlertDialog, C0019R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0019R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0019R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0019R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0019R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0019R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0019R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0019R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0019R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:59:0x00a1, code lost:
        ...
        r1 = r9.findViewById(androidx.appcompat.C0019R.id.titleDividerNoCustom);
     */
    /*
    ...
    */
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0019R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0019R.id.scrollIndicatorDown);
    ...
    /* loaded from: classes.dex */
    class C00222 implements NestedScrollView.OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00222(View view, View view2) {
            this.val$top = view;
    ...
    /* loaded from: classes.dex */
    class RunnableC00233 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00233(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class C00244 implements AbsListView.OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00244(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class RunnableC00255 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00255(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0019R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0019R.id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0019R.id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0019R.id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0019R.id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0019R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0019R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0019R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor != null) {
                    ...
                    adapter = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, R.id.text1, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
