...
@DebugMetadata(m156c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1", m157f = "FlowExt.kt", m158i = {0}, m159l = {90}, m160m = "invokeSuspend", m161n = {"$this$callbackFlow"}, m163s = {"L$0"})
...
final class FlowExtKt$flowWithLifecycle$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m156c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1", m157f = "FlowExt.kt", m158i = {}, m159l = {90}, m160m = "invokeSuspend", m161n = {}, m163s = {})
    /* renamed from: androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1 */
    /* loaded from: classes14.dex */
    public static final class C11971 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C11971(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C11971> continuation) {
            super(2, continuation);
            this.$this_flowWithLifecycle = flow;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C11971(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
        }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C11971(this.$this_flowWithLifecycle, $this$callbackFlow2, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
