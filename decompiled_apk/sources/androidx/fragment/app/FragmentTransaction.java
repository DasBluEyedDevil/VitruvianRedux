...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes14.dex */
    public static final class C1178Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C1178Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C1178Op(int cmd, Fragment fragment, boolean fromExpandedOp) {
            this.mCmd = cmd;
            this.mFragment = fragment;
        ...
        C1178Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
    ...
    public FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction ft) {
        ...
        Iterator<C1178Op> it = ft.mOps.iterator();
        while (it.hasNext()) {
            C1178Op op = it.next();
            this.mOps.add(new C1178Op(op));
        }
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C1178Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C1178Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C1178Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C1178Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C1178Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C1178Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C1178Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C1178Op(10, fragment, state));
        return this;
    }
