...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, C0915R.attr.nestedScrollViewStyle);
    }
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        if (!canScroll) {
            ...
            View nextFocused = FocusFinder.getInstance().findNextFocus(this, currentFocused, GattError.GATT_WRONG_STATE);
            return (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(GattError.GATT_WRONG_STATE)) ? false : true;
        }
        ...
        switch (event.getKeyCode()) {
            ...
            case 20:
                if (event.isAltPressed()) {
                    boolean handled3 = fullScroll(GattError.GATT_WRONG_STATE);
                    return handled3;
                }
                boolean handled4 = arrowScroll(GattError.GATT_WRONG_STATE);
                return handled4;
            ...
            case 92:
                ...
                return handled5;
            case 93:
                boolean handled6 = fullScroll(GattError.GATT_WRONG_STATE);
                return handled6;
            case 122:
                pageScroll(33);
                return false;
            case 123:
                pageScroll(GattError.GATT_WRONG_STATE);
                return false;
            default:
                return false;
        }
    ...
    public final void smoothScrollBy(int dx, int dy) {
        smoothScrollBy(dx, dy, ProgressIndicatorKt.FirstLineTailDelay, false);
    }
    ...
    public final void smoothScrollTo(int x, int y) {
        smoothScrollTo(x, y, ProgressIndicatorKt.FirstLineTailDelay, false);
    }
    ...
    void smoothScrollTo(int x, int y, boolean withNestedScrolling) {
        smoothScrollTo(x, y, ProgressIndicatorKt.FirstLineTailDelay, withNestedScrolling);
    }
    ...
    protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        View nextFocus;
        if (direction == 2) {
            direction = GattError.GATT_WRONG_STATE;
        } else if (direction == 1) {
            direction = 33;
        }
