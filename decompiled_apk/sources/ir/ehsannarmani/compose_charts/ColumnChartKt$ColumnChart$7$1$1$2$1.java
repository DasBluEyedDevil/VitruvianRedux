...
public final class ColumnChartKt$ColumnChart$7$1$1$2$1 implements PointerInputEventHandler {
    ...
    public ColumnChartKt$ColumnChart$7$1$1$2$1(SnapshotStateList<BarPopupData> snapshotStateList, Function1<? super BarPopupData, Unit> function1, PopupProperties popupProperties, MutableState<SelectedBar> mutableState, CoroutineScope coroutineScope, Function1<? super BarPopupData, Unit> function12, Animatable<Float, AnimationVector1D> animatable) {
    ...
    public final Object invoke(PointerInputScope $this$pointerInput, Continuation<? super Unit> continuation) {
        ...
        Function1 function12 = new Function1() { // from class: ir.ehsannarmani.compose_charts.ColumnChartKt$ColumnChart$7$1$1$2$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit invoke$lambda$2;
                invoke$lambda$2 = ColumnChartKt$ColumnChart$7$1$1$2$1.invoke$lambda$2(SnapshotStateList.this, function1, (Offset) obj);
        ...
        Object detectTapGestures$default = TapGestureDetectorKt.detectTapGestures$default($this$pointerInput, null, function12, null, new Function1() { // from class: ir.ehsannarmani.compose_charts.ColumnChartKt$ColumnChart$7$1$1$2$1$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit invoke$lambda$5;
                invoke$lambda$5 = ColumnChartKt$ColumnChart$7$1$1$2$1.invoke$lambda$5(SnapshotStateList.this, popupProperties, mutableState, coroutineScope, function13, animatable, (Offset) obj);
    ...
    public static final Unit invoke$lambda$5(SnapshotStateList $barWithRect, PopupProperties $popupProperties, MutableState $selectedValue, CoroutineScope $scope, Function1 $onBarClick, Animatable $popupAnimation, Offset it) {
        Object element$iv;
        ...
        if (popupData != null) {
            if ($popupProperties.getEnabled()) {
                ...
                float x$iv2 = popupData.getRect().getLeft();
                float y$iv2 = popupData.getBar().getValue() < Utils.DOUBLE_EPSILON ? popupData.getRect().getBottom() : popupData.getRect().getTop();
                long v1$iv$iv2 = Float.floatToRawIntBits(x$iv2);
                long v2$iv$iv2 = Float.floatToRawIntBits(y$iv2);
                $selectedValue.setValue(new SelectedBar(bar, Offset.m5633constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L)), rect, popupData.getDataIndex(), popupData.getValueIndex(), null));
                BuildersKt__Builders_commonKt.launch$default($scope, null, null, new ColumnChartKt$ColumnChart$7$1$1$2$1$2$2$1($popupAnimation, $popupProperties, null), 3, null);
            }
            if ($onBarClick != null) {
