...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> HashMap<K, V> hashMapOf(Pair<? extends K, ? extends V>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        HashMap $this$hashMapOf_u24lambda_u240 = new HashMap(MapsKt.mapCapacity(pairs.length));
        MapsKt.putAll($this$hashMapOf_u24lambda_u240, pairs);
        return $this$hashMapOf_u24lambda_u240;
    }
