...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File $this$toRelativeStringOrNull, File base) {
        ...
        if (i < thisCount) {
            ...
            CollectionsKt.joinTo(CollectionsKt.drop(thisComponents.getSegments(), i), res, (r14 & 2) != 0 ? ", " : separator, (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : null);
        }
        return res.toString();
    }
        ...
        if ($this$copyTo.isDirectory()) {
            ...
            try {
                ...
                try {
                    ...
                    long copyTo = ByteStreamsKt.copyTo(input, output, bufferSize);
    ...
    public static final boolean copyRecursively(File $this$copyRecursively, File target, boolean overwrite, final Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        ...
        try {
            Iterator<File> it = FilesKt.walkTopDown($this$copyRecursively).onFail(new Function2() { // from class: kotlin.io.FilesKt__UtilsKt$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final Unit copyRecursively$lambda$0$FilesKt__UtilsKt(Function2 $onError, File f, IOException e) {
    ...
    public static final File normalize(File $this$normalize) {
        ...
        List<File> normalize$FilesKt__UtilsKt = normalize$FilesKt__UtilsKt($this$normalize_u24lambda_u240.getSegments());
        String separator = File.separator;
        Intrinsics.checkNotNullExpressionValue(separator, "separator");
