...
/**
 * Data Access Object for exercises and exercise videos.
 * Provides methods for managing exercise definitions and their associated video content.
 */
@Dao
interface ExerciseDao {
    ...
    @Query("SELECT * FROM exercise_videos WHERE exerciseId = :exerciseId ORDER BY `order` ASC")
    ...
    @Transaction
    suspend fun insertExerciseWithVideos(exercise: ExerciseEntity, videos: List<ExerciseVideoEntity>) {
        insert(exercise)
        insertVideos(videos)
    }
}
